...
const ProjectsPage = () => {
  ...
  const projects = [
    {
      title: "Hamuntu",
      description: "A web app for managing school clubs. Features event scheduling, member tracking, announcements, and document sharing in one intuitive platform.",
      image: "/hamuntu.png",
    ...
    {
      title: "Paro",
      description: "A community-driven web app designed to connect people, foster engagement, and facilitate collaboration.",
      image: "/paro.png",
    ...
    {
      title: "GG",
      description: "An all-in-one sports event and community app that connects players, organizers, and fans in one place. Discover tournaments, join events, and stay updated with ease.",
      image: "/GG_Whistle.svg",
      link: "https://gg-zeta-seven.vercel.app/",
      fullDescription: "GG is an all-in-one sports event and community app designed to bring athletes, organizers, and fans together in one dynamic platform.\n\nKey Features:\n• Event Discovery: Browse upcoming tournaments and leagues near you.\n• Easy Registration: Join games or events in just a few taps.\n• Organizer Tools: Post events, manage teams, and track participants.\n• Player Profiles: Showcase your sports journey and achievements.\n• Real-Time Updates: Stay informed about match schedules, results, and announcements.\n• Social Interaction: Connect with other players and share your sports experiences.\n\nExperience sports the smarter way with GG!"
    }
  ];
            ...
            <div className="p-4">
              ...
              {selectedProject.link && (
                <a 
                  ...
                  className="block mt-4 text-center w-full py-2 bg-[#ff00ff] text-white rounded-full text-xs font-medium hover:bg-[#ff40ff] transition-all duration-300"
                >
                  Visit App
                </a>
              )}
